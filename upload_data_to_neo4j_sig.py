...
# ================= 配置部分 =================
file_path = "./data/waite_to_neo4j/south_china_sig.xlsx"
target_columns = ['what', 'where', 'when', 'who', 'why', 'how', 'title','organization']

neo4j_config = {
    "uri": "bolt://172.20.69.92:7687",
    "user": "neo4j",
    "password": "neo4j@openspg",
    "database": "southChinaSig"
}
# ===========================================
...
def import_batch(tx, batch):
    ...
    for _, row in batch.iterrows():
        try:
                        ...
                        if label == 'Who':
                            ...
                            if '-' in v:
                                ...
                                if person and org:
                                    ...
                                    tx.run("""MATCH (a:What {name: $what, title: $title}), (b:Who {name: $v})
                                        MERGE (a)-[:参与者]->(b)
            ...
            # link_node('category', 'Category', '类型')
